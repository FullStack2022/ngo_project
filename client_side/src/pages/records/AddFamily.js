...
import { ADD_FAMILY } from '../../config/Constants';
...
const AddFamily = () => {
    ...
    const saveFamily = async () => {
        ...
        if(title == ""){
            ...
            const response = await fetch(ADD_FAMILY, schemaOption);
                ...
                <div className="main-panel">
                    <div className="content-wrapper">
                        <div className="page-header">
                            <h3 className="page-title"> Add Family </h3>
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item">Records</li>
                                    <li className="breadcrumb-item active" aria-current="page">Add Family</li>
                                </ol>
                            </nav>
                        </div>
                        <div className="row">
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <h4 className="card-title">Family Information</h4>
                                            ...
                                            <button type="button" className="btn btn-gradient-success btn-fw" onClick={() => saveFamily() }>{isLoading ? 'Loading...':'Save'}</button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-6">
