(function($) {
  ...
  $(function() {
    ...
    if ($("#visit-sale-chart").length) {
      ...
      var gradientStrokeViolet = ctx.createLinearGradient(0, 0, 0, 181);
      gradientStrokeViolet.addColorStop(0, '#07cdae');
      gradientStrokeViolet.addColorStop(1, '#07cdae');
      var gradientLegendViolet = 'linear-gradient(to right, rgb(132, 217, 210), rgb(7, 205, 174))';
      
      var gradientStrokeBlue = ctx.createLinearGradient(0, 0, 0, 360);
      gradientStrokeBlue.addColorStop(0, '#fe7096');
      gradientStrokeBlue.addColorStop(1, '#fe7096');
      var gradientLegendBlue = 'linear-gradient(to right, rgb(255, 191, 150), rgb(254, 112, 150))';

      var gradientStrokeRed = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokeRed.addColorStop(0, '#047edf');
      gradientStrokeRed.addColorStop(1, '#047edf');
      var gradientLegendRed = 'linear-gradient(to right, rgb(144, 202, 249), rgb(4, 126, 223))';


      var gradientStrokePending = ctx.createLinearGradient(246, 227, 132,1);
      gradientStrokePending.addColorStop(0, '#9a55ff');
      gradientStrokePending.addColorStop(1, '#9a55ff');
      var gradientLegendPending = 'linear-gradient(to right, rgb(218, 140, 255), rgb(154, 85, 255))';
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
              ...
              {
                label: "Pending",
                borderColor: gradientLegendPending,
                backgroundColor: gradientLegendPending,
                hoverBackgroundColor: gradientLegendPending,
                legendColor: gradientLegendPending,
                pointRadius: 0,
                fill: false,
                borderWidth: 1,
                fill: 'origin',
                data: [70, 10, 30, 20, 10, 50, 15, 30]
              }
          ]
        },
        options: {
