    ...
    <>
      <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a className="navbar-brand brand-logo" href="index.html"><img src={BASE_URL+`/assets/images/logo.svg`} alt="logo" /></a>
          <a className="navbar-brand brand-logo-mini" href="index.html"><img src={BASE_URL+`assets/images/logo-mini.svg`} alt="logo" /></a>
        </div>
          ...
          <div className="search-field d-none d-md-block">
            <form className="d-flex align-items-center h-100" action="#">
              <div className="input-group">
                ...
                <input type="text" className="form-control bg-transparent border-0" placeholder="Search Members" />
              </div>
            </form>
          </div>
            ...
            <li className="nav-item nav-profile dropdown">
              <a className="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div className="nav-profile-text">
                  <p className="mb-1 text-black">Deepak Tailor</p>
                </div>
              </a>
              <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                ...
                <a className="dropdown-item" href="javascript:void(0);" onClick={() => loginAdmin()}>
